...
const Home = async () => {
  ...
  return (
    <>
      {/* Motto */}
      <div className="h-48 md:h-42 w-full bg-dot-black/[0.2] dark:bg-dot-white/[0.2] relative flex items-center justify-center text-2xl/snug xs:text-3xl/snug lg:text-4xl/snug font-bold self-center text-center">
