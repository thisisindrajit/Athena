...
const Footer = () => {
  return (
    <div className="flex items-center justify-center gap-2 bg-primary/5 text-primary w-full p-4 rounded-t-lg text-sm border-t border-x border-primary/50 border-dashed">
      <CDialogHolder
        trigger={
